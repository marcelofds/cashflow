...
public class BillingToReceiveControllerTest
{
    ...
    {
        //Arrange
        BillToReceiveDto? expected = new BillToReceiveDto();
    ...
    {
        //Arrange
        Expression<Func<IBillingService, Task>> addBillToReceiveAsyncSetup = s => s.IncludeNewBillToReceiveAsync(It.IsAny<BillToReceiveInsertDto>());
