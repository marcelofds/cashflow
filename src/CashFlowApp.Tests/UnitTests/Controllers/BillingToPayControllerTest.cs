...
public class BillingToPayControllerTest
{
    ...
    {
        //Arrange
        BillToPayDto? expected = new BillToPayDto();
    ...
    {
        Expression<Func<IBillingService, Task>> addBillToPayAsyncSetup = s => s.IncludeNewBillToPayAsync(It.IsAny<BillToPayInsertDto>());
        //Arrange
