...
public static class ExceptionMiddleware
{
    ...
    public static void ConfigureExceptionMiddleware(this IApplicationBuilder app) => app
    ...
    private static int GetStatusCodeByExceptionType(Exception exception) => exception switch
    {
